class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/4.1.1/neo4j-migrations-4.1.1-osx-aarch_64.zip"
  version "4.1.1"
  sha256 "cb94ce021fbdd6ddf4ddf460601edad9ff9686fa78ec07cc10dd3d19dd3b7757"
  ...
  test do
    ...
    assert_match "neo4j-migrations/4.1.1", output
  end
end
