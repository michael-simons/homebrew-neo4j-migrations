class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.17.3/neo4j-migrations-2.17.3-osx-aarch_64.zip"
  version "2.17.3"
  sha256 "f3d8df9b8ddf7ff5724110e4d4dac301c24bf895ee19e0dc061af01c0ceea88a"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.17.3", output
  end
end
