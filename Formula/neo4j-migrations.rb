class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/1.13.1/neo4j-migrations-1.13.1-osx-x86_64.zip"
  version "1.13.1"
  sha256 "ecf820648d23338c099345dc5044bb89e6b20fdd880ad1fdec7c505d789161d3"
  ...
  test do
    ...
    assert_match "neo4j-migrations/1.13.1", output
  end
end
