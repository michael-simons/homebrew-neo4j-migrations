class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/1.5.1/neo4j-migrations-1.5.1-osx-x86_64.zip"
  version "1.5.1"
  sha256 "8179846389a6d0945170318aa07f10bdf0edb92cd6edb879a3908762b54e8228"
  ...
  test do
    ...
    assert_match "neo4j-migrations/1.5.1", output
  end
end
