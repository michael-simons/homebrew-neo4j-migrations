class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/1.3.1/neo4j-migrations-1.3.1-osx-x86_64.zip"
  version "1.3.1"
  sha256 "03afa16822ad046eaf68d322c8c23f817a66ff1c6a31bb936faec03cd5fb2d56"
  ...
  test do
    ...
    assert_match "neo4j-migrations/1.3.1", output
  end
end
