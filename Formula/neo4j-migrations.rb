class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/1.9.2/neo4j-migrations-1.9.2-osx-x86_64.zip"
  version "1.9.2"
  sha256 "73eb332a9cf48464a58258a9166e43f5267318ae84b0917e29581b318d1aedc9"
  ...
  test do
    ...
    assert_match "neo4j-migrations/1.9.2", output
  end
end
