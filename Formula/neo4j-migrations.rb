class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/3.3.1/neo4j-migrations-3.3.1-osx-aarch_64.zip"
  version "3.3.1"
  sha256 "db167abe2459c57a753599d76866af74bab1578632429a7c4d3515c0e7c3cdeb"
  ...
  test do
    ...
    assert_match "neo4j-migrations/3.3.1", output
  end
end
