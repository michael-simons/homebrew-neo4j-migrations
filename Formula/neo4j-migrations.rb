class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/1.13.2/neo4j-migrations-1.13.2-osx-x86_64.zip"
  version "1.13.2"
  sha256 "3a92030774fa8e29aa9f07acbb1bf247b9c8c972a744deab866d15aa22f24870"
  ...
  test do
    ...
    assert_match "neo4j-migrations/1.13.2", output
  end
end
