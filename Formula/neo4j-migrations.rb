class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.19.0/neo4j-migrations-2.19.0-osx-aarch_64.zip"
  version "2.19.0"
  sha256 "3d71b8c3aa00fe867d48924e213b33dd99897b7825f77dbe435cb6fcf22325f4"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.19.0", output
  end
end
