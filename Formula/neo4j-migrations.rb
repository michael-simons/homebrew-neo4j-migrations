class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/1.3.0/neo4j-migrations-1.3.0-osx-x86_64.zip"
  version "1.3.0"
  sha256 "7590e3f06fc121617918ea27fc22a264d47414b9bd5c1d889aa9440ecfefb54e"
  ...
  test do
    ...
    assert_match "neo4j-migrations/1.3.0", output
  end
end
