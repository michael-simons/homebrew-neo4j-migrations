class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/1.5.0/neo4j-migrations-1.5.0-osx-x86_64.zip"
  version "1.5.0"
  sha256 "592423bb7aff8eae30d7250ba9d67d84e9782bb185b3a6972f2a8aaaebdaaf7e"
  ...
  test do
    ...
    assert_match "neo4j-migrations/1.5.0", output
  end
end
