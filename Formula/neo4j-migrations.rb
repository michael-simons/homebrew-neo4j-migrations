class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/4.0.2/neo4j-migrations-4.0.2-osx-aarch_64.zip"
  version "4.0.2"
  sha256 "b175b6e34d15a99eade6e7118ddb405aa6bf9691d8d8e119db95be7eafc10fe8"
  ...
  test do
    ...
    assert_match "neo4j-migrations/4.0.2", output
  end
end
