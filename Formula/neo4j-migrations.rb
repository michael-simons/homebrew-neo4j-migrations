class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.17.2/neo4j-migrations-2.17.2-osx-aarch_64.zip"
  version "2.17.2"
  sha256 "e9352483e85427653ea77d156f868bdb10380ee02c6d8fc91be6ebaa981f9da7"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.17.2", output
  end
end
