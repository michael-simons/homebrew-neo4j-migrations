class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.18.2/neo4j-migrations-2.18.2-osx-aarch_64.zip"
  version "2.18.2"
  sha256 "de745aa6d91d6376b61733dd0d40be822c4d11364f0d4defc56ede26b0b4c388"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.18.2", output
  end
end
