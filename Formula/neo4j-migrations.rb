class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/1.3.2/neo4j-migrations-1.3.2-osx-x86_64.zip"
  version "1.3.2"
  sha256 "02749f16d41e9b37f2320c5cf952777a901eb5242b78916653eb3284ee1a2f22"
  ...
  test do
    ...
    assert_match "neo4j-migrations/1.3.2", output
  end
end
