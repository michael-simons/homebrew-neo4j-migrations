class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/1.5.3/neo4j-migrations-1.5.3-osx-x86_64.zip"
  version "1.5.3"
  sha256 "760cb6f198ba8f7ff5e0ad2da490cede870580b57fa3a48604bcbbcec2b9aedf"
  ...
  test do
    ...
    assert_match "neo4j-migrations/1.5.3", output
  end
end
