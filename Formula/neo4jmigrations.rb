class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.13.4/neo4j-migrations-2.13.4-osx-aarch_64.zip"
  version "2.13.4"
  sha256 "bba2c7bfa50db8397c8f676a91e06d69167a22afb9d6740338238d19df1e7caa"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.13.4", output
  end
end
