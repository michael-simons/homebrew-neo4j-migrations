class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.10.0/neo4j-migrations-2.10.0-osx-x86_64.zip"
  version "2.10.0"
  sha256 "87d8062ea4232fc555f1147f0c9f8b4f8f1b271fd23025b6b8ada0c7408616e7"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.10.0", output
  end
end
