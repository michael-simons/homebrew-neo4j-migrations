class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.0.1/neo4j-migrations-2.0.1-osx-x86_64.zip"
  version "2.0.1"
  sha256 "6e89cc965631c0f424f65b4fa984da9e7de9191c24e316c6894ef86166ea6ef0"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.0.1", output
  end
end
