class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.8.2/neo4j-migrations-2.8.2-osx-x86_64.zip"
  version "2.8.2"
  sha256 "ba8635653ab13e914107b83648b8d00fe66e01425300549c2a990621078eae62"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.8.2", output
  end
end
