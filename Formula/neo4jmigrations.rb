class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.2.1/neo4j-migrations-2.2.1-osx-x86_64.zip"
  version "2.2.1"
  sha256 "15b55253d0af81afa5455801d6b9a735a84f4e3ba745fc91e4115c49ac848ad4"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.2.1", output
  end
end
