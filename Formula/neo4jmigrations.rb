class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.10.1/neo4j-migrations-2.10.1-osx-aarch_64.zip"
  version "2.10.1"
  sha256 "6380bb3d0db285cf94833bce4625bf7fcac292bfbd65c4c0acec1a5c330b1688"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.10.1", output
  end
end
