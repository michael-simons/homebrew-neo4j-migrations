class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.5.1/neo4j-migrations-2.5.1-osx-x86_64.zip"
  version "2.5.1"
  sha256 "59df3720da01014d3da25ed74d21b7f007cfa3f8daf7627bf288e7d3d98cbe17"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.5.1", output
  end
end
