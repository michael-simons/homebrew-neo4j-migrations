class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.0.0/neo4j-migrations-2.0.0-osx-x86_64.zip"
  version "2.0.0"
  sha256 "d4604def5ad34851f2c2f87ff784da76fa83e92539eedf3f592d431915579fe5"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.0.0", output
  end
end
