class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.8.1/neo4j-migrations-2.8.1-osx-x86_64.zip"
  version "2.8.1"
  sha256 "2730b6df1aec295f609cd2a42b8e8217945ed173ffb9ad080bead83559bf8a51"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.8.1", output
  end
end
