class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.7.0/neo4j-migrations-2.7.0-osx-x86_64.zip"
  version "2.7.0"
  sha256 "f82dfd5752bdc2ea78ddf37cab830269e00acacdc34574cfd8ea1d179ca399ee"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.7.0", output
  end
end
