class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/1.15.1/neo4j-migrations-1.15.1-osx-x86_64.zip"
  version "1.15.1"
  sha256 "486ce985f308d5b7637872492286a3054b155713a56d09b6966e414155de7a24"
  ...
  test do
    ...
    assert_match "neo4j-migrations/1.15.1", output
  end
end
