class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.4.0/neo4j-migrations-2.4.0-osx-x86_64.zip"
  version "2.4.0"
  sha256 "b8bf4be1ba2b406133aead0d38e4291c6b657faabae0b0525109c212d4797764"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.4.0", output
  end
end
