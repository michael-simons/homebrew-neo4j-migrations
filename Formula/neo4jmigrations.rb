class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.15.2/neo4j-migrations-2.15.2-osx-aarch_64.zip"
  version "2.15.2"
  sha256 "9398c66c571a4b4d278863b93c87ddfc536c8a9888896b089decb4165d89b272"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.15.2", output
  end
end
