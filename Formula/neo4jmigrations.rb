class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.14.1/neo4j-migrations-2.14.1-osx-aarch_64.zip"
  version "2.14.1"
  sha256 "3d302420f6713a5a47a98ea8a2b5d8ea908316380bb3b9d583178fd19e6595f3"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.14.1", output
  end
end
