class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.9.3/neo4j-migrations-2.9.3-osx-x86_64.zip"
  version "2.9.3"
  sha256 "227e5535d9748e40b335f090e6238bc02acb8dcb3162570f5692f81be9faa676"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.9.3", output
  end
end
