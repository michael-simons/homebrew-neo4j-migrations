class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.14.0/neo4j-migrations-2.14.0-osx-aarch_64.zip"
  version "2.14.0"
  sha256 "da92c83c1b305faf2d1f180afdafec5ab4db8e7795304c7250ab5735f5d3f886"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.14.0", output
  end
end
