class Neo4jMigrations < Formula
  ...
  url "https://github.com/michael-simons/neo4j-migrations/releases/download/2.10.3/neo4j-migrations-2.10.3-osx-aarch_64.zip"
  version "2.10.3"
  sha256 "f1649865ff27727540f3e78ffe2410d0a427f4f7794ff9262291715752aa5808"
  ...
  test do
    ...
    assert_match "neo4j-migrations/2.10.3", output
  end
end
